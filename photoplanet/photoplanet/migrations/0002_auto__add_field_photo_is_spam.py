...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.is_spam'
        db.add_column(u'photoplanet_photo', 'is_spam',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.is_spam'
        db.delete_column(u'photoplanet_photo', 'is_spam')
    ...
    models = {
        ...
        u'photoplanet.photo': {
            ...
            'photo_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'primary_key': 'True'}),
